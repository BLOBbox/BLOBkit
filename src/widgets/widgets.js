	...
	try {
		...
		if (document.getElementById('TVB.widget.colorButtonsBarHandler') === null) {
			...
			*/
			...
			TVB.widget.colorButtonsBarB1Handler.style.backgroundPosition = '1px left';
			...
			TVB.widget.colorButtonsBarB2Handler.style.backgroundPosition = '1px left';
			...
			TVB.widget.colorButtonsBarB3Handler.style.backgroundPosition = '1px left';
			...
			TVB.widget.colorButtonsBarB4Handler.style.backgroundPosition = '1px left';
